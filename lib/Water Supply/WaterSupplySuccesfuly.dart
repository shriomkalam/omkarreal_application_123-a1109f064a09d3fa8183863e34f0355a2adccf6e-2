...
class WaterSupplySuccesfuly extends StatefulWidget {
  const WaterSupplySuccesfuly({super.key});

  @override
  State<WaterSupplySuccesfuly> createState() => _WaterSupplySuccesfulyState();
}

class _WaterSupplySuccesfulyState extends State<WaterSupplySuccesfuly> {
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        "Your Water Supply Request Submitted Successfully!.\n your tracking id is:-",
                                        style: TextStyle(
