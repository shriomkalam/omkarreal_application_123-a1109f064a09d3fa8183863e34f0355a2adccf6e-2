...
class CleaningSuccesfuly extends StatefulWidget {
  // const CleaningSuccesfuly({super.key});

   final    rana;
  CleaningSuccesfuly(this.rana);
  @override
  State<CleaningSuccesfuly> createState() => _CleaningSuccesfulyState();
}

class _CleaningSuccesfulyState extends State<CleaningSuccesfuly> {
