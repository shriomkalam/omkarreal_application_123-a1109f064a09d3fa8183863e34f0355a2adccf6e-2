...
class ElectricSuccesfuly extends StatefulWidget {
  const ElectricSuccesfuly({super.key});

  @override
  State<ElectricSuccesfuly> createState() => _ElectricSuccesfulyState();
}

class _ElectricSuccesfulyState extends State<ElectricSuccesfuly> {
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        "Your Electricity Request Submitted Successfully!.\n your tracking id is:-",
